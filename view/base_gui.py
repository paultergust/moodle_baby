...
layout = [
    [sg.Frame("Frame 1", layout_frame1, size=(480, 450), expand_x=True, expand_y=True),
     sg.Frame("Frame 2", layout_frame2, size=(400, 450), expand_x=True, expand_y=True, title_location=sg.TITLE_LOCATION_TOP)],]
